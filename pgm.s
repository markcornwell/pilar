...
# (codes ((f53 (code (x y) () (fx+ x y))) (f52 (code (x) (g) (g x x)))) (letrec ((f (closure f52 g)) (g (closure f53))) (f 12)))

# emit-codes expr=(codes ((f53 (code (x y) () (fx+ x y))) (f52 (code (x) (g) (g x x)))) (letrec ((f (closure f52 g)) (g (closure f53))) (f 12)))
#  bindings=((f53 (code (x y) () (fx+ x y))) (f52 (code (x) (g) (g x x))))
#  lvars=(f53 f52)
#  codes=((code (x y) () (fx+ x y)) (code (x) (g) (g x x)))
#  labels=("_L_97" "_L_96")
...
#  si   = -4
#  env  = ((f53 . "_L_97") (f52 . "_L_96"))
#  bindings = ((f (closure f52 g)) (g (closure f53)))
#  body = (begin (f 12))
# closure
#  si   =-4
